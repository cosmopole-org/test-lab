...
impl Statistics {
    ...
    pub fn create() -> WasmEdgeResult<Self> {
        let ctx: *mut ffi::WasmEdge_StatisticsContext = unsafe { ffi::WasmEdge_StatisticsCreate() };
        match ctx.is_null() {
    ...
    pub fn create_of_ctx(ctx: *mut ffi::WasmEdge_StatisticsContext) -> WasmEdgeResult<Self> {
        match ctx.is_null() {
            true => Err(Box::new(WasmEdgeError::StatisticsCreate)),
            false =>
                Ok(Statistics {
